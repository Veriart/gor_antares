        ...
        <div class="card-body border-bottom position-relative">
            ...
            <div class="mt-6">
                ...
                <div class="man-working-on-laptop">
                    <img src="vendor/assets/images/backgrounds/man-working-on-laptop.png"
        ...
        <div class="card-body">
            <div class="d-md-flex justify-content-between mb-9">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown">
                        <a href="javascript:void(0)" class="btn border shadow-none px-3"
                ...
                <table class="table mb-0 align-middle text-nowrap">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center product text-truncate">
                                    <img src="vendor/assets/images/products/product-5.png"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center product text-truncate">
                                    <img src="vendor/assets/images/products/product-6.png"
                                        class="img-fluid flex-shrink-0" width="60"
                                        height="60">
                                    <div class="ms-3 product-title">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center product text-truncate">
                                    <img src="vendor/assets/images/products/product-7.png"
                                        class="img-fluid flex-shrink-0" width="60"
                                        height="60">
                                    <div class="ms-3 product-title">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center product text-truncate">
                                    <img src="vendor/assets/images/products/product-8.png"
                                        class="img-fluid flex-shrink-0" width="60"
                                        height="60">
                                    <div class="ms-3 product-title">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center product text-truncate">
                                    <img src="vendor/assets/images/products/product-9.png"
                                        class="img-fluid flex-shrink-0" width="60"
                                        height="60">
                                    <div class="ms-3 product-title">
